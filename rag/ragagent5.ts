...
const result = await agent.invoke({
  messages : [{role: "user", content : "What was Nike revenue in 2024 & 2025 and from which town Nike has grown into world famous footwear & what is weather in that town"}]
